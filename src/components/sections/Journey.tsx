...
export default function Journey() {
  ...
  const timelineData = [
    ...
    {
      year: '২০০৩',
      title: 'চিথলিয়া ইউনিয়ন বিএনপির যুগ্ম সাধারণ সম্পাদক',
      description: 'চিথলিয়া ইউনিয়ন বিএনপির যুগ্ম সাধারণ সম্পাদক হিসেবে দায়িত্ব পালন করেন। একই সময়ে উপজেলা ছাত্রদলের সঙ্গে যুক্ত থেকে ভারপ্রাপ্ত সাধারণ সম্পাদকের দায়িত্বও সফলভাবে পালন করেন।',
      isCurrent: false,
    },
    {
      year: '১৯৯৯',
