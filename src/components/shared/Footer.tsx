...
export default function Footer() {
  ...
  const handleUnavailableLink = (e: React.MouseEvent, platform: string) => {
    e.preventDefault();
    alert(`Sorry, the ${platform} page isn't available right now. Please check back later.`);
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 mb-12 md:mb-16 border-b border-white/10 pb-12 md:pb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="font-sans text-cream/70 text-[14px] leading-7 max-w-sm mb-6">
              তৃণমূলের সুদীর্ঘ রাজপথের পরীক্ষিত নেতৃত্ব। চিথলিয়া ইউনিয়নের মানুষের অধিকার, শান্তি ও একটি দুর্নীতিমুক্ত মডেল সমাজ গড়ার অদম্য প্রতিজ্ঞায় নিবেদিত প্রাণ।
            </p>
            ...
            <div className="flex items-center gap-3">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/taj.rashad/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-[#1877F2] hover:border-[#1877F2] transition-all" title="Facebook">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                </svg>
              </a>

              {/* WhatsApp (Fixed Clean SVG) */}
              <a href="https://wa.me/8801862674369" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-[#25D366] hover:border-[#25D366] transition-all" title="WhatsApp">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              {/* X (Twitter) */}
              <a href="#" onClick={(e) => handleUnavailableLink(e, 'Twitter/X')} className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-black hover:border-black transition-all" title="Twitter">
              ...
              {/* Instagram */}
              <a href="#" onClick={(e) => handleUnavailableLink(e, 'Instagram')} className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-[#E4405F] hover:border-[#E4405F] transition-all" title="Instagram">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              {/* YouTube */}
              <a href="#" onClick={(e) => handleUnavailableLink(e, 'YouTube')} className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-[#FF0000] hover:border-[#FF0000] transition-all" title="YouTube">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:01862674369" className="text-cream/70 hover:text-white transition-colors text-[14px]">০১৮৬২৬৭৪৩৬৯</a>
              </li>
              <li className="flex items-center gap-3">
